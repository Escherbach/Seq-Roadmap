...
The final point may be surprising to those familiar with sequencing as applied to whole human genomes. However, as shown in Appendix A, very short reads can be effective when sequencing and assembling small (SARS-CoV-2 30Kb) viral genomes and a diagnostic platform with sensitivity and specificity superior to qPCR can be developed with these specifications.
